...
class Database
{
     ...
     * 
     * @var    $_pdo  Reference & handle for PDO instance.
     * @access private
     */
    private $_pdo = null;
    ...
    public function __construct($hostname, $username, $password, $database)
    {
        ...
        try {
            $this->_pdo = new PDO('mysql:host=' . $this->_hostname .';dbname=' . $this->_database . ';charset=UTF8', $this->_username, $this->_password, $this->_options);
